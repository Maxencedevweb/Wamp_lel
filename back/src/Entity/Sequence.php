...
#[ApiResource(
    normalizationContext: ['groups' => ['sequence:read'],  'enable_max_depth' => true,
        'max_depth' => 2],
...
class Sequence
{
    ...
    public function addContenus(Contenu $contenu): static
    {
